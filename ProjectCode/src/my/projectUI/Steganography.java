...
public class Steganography
{
	...
	public static boolean encode(String path, String original, String ext1,String message)
	{
              String  stegan = new String("default");
               
                
		String	file_name = image_path(path,original,ext1);
                
		BufferedImage 	image_orig = getImage(file_name);
		System.out.println(stegan);
	
                
	        image = user_space(image_orig);
		image = add_text(image,message);
               
                
             path="C:\\Users\\sayed shazeb\\Downloads\\Documents";
	...
	public static boolean setImage(BufferedImage image, File file, String ext)
	{
        ...
        public static boolean save(String pth){
            ...
            return( setImage(image,file,"png"));
        }
